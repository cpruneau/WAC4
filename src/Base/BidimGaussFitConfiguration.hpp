 ...
 *************************************************************************/
#ifndef WAC_BidimGaussFitConfiguration
#define WAC_BidimGaussFitConfiguration
#include "TString.h"
#include <iostream>
#include <ostream>
#include <fstream>
...
class BidimGaussFitConfiguration
{
  public:
  ...
  void printConfiguration(ostream & out) const;
...
#endif /* WAC_BidimGaussFitConfiguration */
