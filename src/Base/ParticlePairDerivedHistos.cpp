...
{
  if (reportInfo("ParticlePairDerivedHistos",getName(),"createHistograms()")) cout << endl << "Started." << endl;
  TString name;
  ...
  double zero        = 0.0;
  double nBinsPhiEta = nBinsPhiEta;
  ...
  if (ac.fillEta)
    {
    h_n1n1_phiEtaPhiEta    = createHistogram(bn+TString("n1n1_phiEtaPhiEta"),   ac.nBins_phiEta, zero,nBinsPhiEta, ac.nBins_phiEta, zero,nBinsPhiEta,  "#eta_{1} x #varphi_{1}", "#eta_{2} x #varphi_{2}", "<n_{1}><n_{1}>", 0,1,0,0);
    ...
    h_R2_phiEtaPhiEta      = createHistogram(bn+TString("R2_phiEtaPhiEta"),     ac.nBins_phiEta, zero,nBinsPhiEta, ac.nBins_phiEta, zero,nBinsPhiEta,       "#eta_{1} x #varphi_{1}", "#eta_{2} x #varphi_{2}", "R_{2}", 0,1,0,0);
    ...
    if (ac.computeBF)
      {
      h_bf12_phiEtaPhiEta    = createHistogram(bn+TString("bf12_phiEtaPhiEta"),   ac.nBins_phiEta, zero,nBinsPhiEta, ac.nBins_phiEta, zero,nBinsPhiEta,       "#eta x #varphi", "#eta x #varphi","n_{2}^{12}/n_{1}^{2}", false, true, false, false);
      ...
      h_bf21_phiEtaPhiEta    = createHistogram(bn+TString("bf21_phiEtaPhiEta"),   ac.nBins_phiEta,zero,         nBinsPhiEta,  ac.nBins_phiEta,zero,nBinsPhiEta,       "#eta x #varphi", "#eta x #varphi","n_{2}^{21}/n_{1}^{1}", false, true, false, false);
    ...
    if (ac.computeP2)
      {
      h_pt1pt1_phiEtaPhiEta  = createHistogram(bn+TString("pt1pt1_phiEtaPhiEta"), ac.nBins_phiEta, zero,nBinsPhiEta, ac.nBins_phiEta, zero,nBinsPhiEta,       "#eta_{1} x #varphi_{1}", "#eta_{2} x #varphi_{2}", "pt1pt1", 0,1,0,0);
      ...
      h_DptDpt_phiEtaPhiEta  = createHistogram(bn+TString("DptDpt_phiEtaPhiEta"), ac.nBins_phiEta, zero,nBinsPhiEta, ac.nBins_phiEta, zero,nBinsPhiEta,       "#eta_{1} x #varphi_{1}", "#eta_{2} x #varphi_{2}", "<#Delta p_{T} #Delta p_{T}>", 0,1,0,0);
  ...
  if (ac.computeG2)
    {
    h_G2_phiEtaPhiEta      = createHistogram(bn+TString("G2_phiEtaPhiEta"),     ac.nBins_phiEta, zero,nBinsPhiEta, ac.nBins_phiEta, zero,nBinsPhiEta,       "#eta x #varphi", "#eta x #varphi","G_{2}", 0,1,0,0);
  ...
  if (ac.fillY)
    {
    h_n1n1_phiYPhiY     = createHistogram(bn+TString("n1n1_phiYPhiY"),     ac.nBins_phiY, zero,double(ac.nBins_phiY), ac.nBins_phiY, zero,double(ac.nBins_phiY),        "y_{1} x #varphi_{1}", "y_{2} x #varphi_{2}", "<n_{1}><n_{1}>", 0,1,0,0);
    ...
    h_R2_phiYPhiY       = createHistogram(bn+TString("R2_phiYPhiY"),       ac.nBins_phiY, zero,double(ac.nBins_phiY), ac.nBins_phiY, zero,double(ac.nBins_phiY),         "y_{1} x #varphi_{1}", "y_{2} x #varphi_{2}", "R_{2}", 0,1,0,0);
    ...
    if (ac.computeBF)
      {
      h_bf12_phiYPhiY     = createHistogram(bn+TString("bf12_phiYPhiY"),     ac.nBins_phiY, zero,double(ac.nBins_phiY), ac.nBins_phiY, zero,double(ac.nBins_phiY),         "y_{1} x #varphi_{1}", "y_{2} x #varphi_{2}", "n_{2}^{12}/n_{1}^{2}", false, true, false, false);
      ...
      h_bf21_phiYPhiY     = createHistogram(bn+TString("bf21_phiYPhiY"),     ac.nBins_phiY, zero,double(ac.nBins_phiY), ac.nBins_phiY, zero,double(ac.nBins_phiY),         "y_{1} x #varphi_{1}", "y_{2} x #varphi_{2}", "n_{2}^{21}/n_{1}^{1}", false, true, false, false);
    ...
    if (ac.computeP2)
      {
      h_pt1pt1_phiYPhiY   = createHistogram(bn+TString("pt1pt1_phiYPhiY"),   ac.nBins_phiY, zero,double(ac.nBins_phiY), ac.nBins_phiY, zero,double(ac.nBins_phiY),         "y_{1} x #varphi_{1}", "y_{2} x #varphi_{2}", "pt1pt1", 0,1,0,0);
      ...
      h_DptDpt_phiYPhiY   = createHistogram(bn+TString("DptDpt_phiYPhiY"),   ac.nBins_phiY, zero,double(ac.nBins_phiY), ac.nBins_phiY, zero,double(ac.nBins_phiY),         "y_{1} x #varphi_{1}", "y_{2} x #varphi_{2}", "<#Delta p_{T} #Delta p_{T}>", 0,1,0,0);
    ...
    if (ac.computeG2)
      {
      h_G2_phiYPhiY       = createHistogram(bn+TString("G2_phiYPhiY"),       ac.nBins_phiY, zero,double(ac.nBins_phiY), ac.nBins_phiY, zero,double(ac.nBins_phiY),         "y_{1} x #varphi_{1}", "y_{2} x #varphi_{2}", "G_{2}", 0,1,0,0);
...
{
  if (reportInfo("ParticlePairDerivedHistos",getName(),"loadHistograms(TFile * inputFile)")) cout << endl << "Started." << endl;
  ParticlePairAnalyzerConfiguration & ac = * (ParticlePairAnalyzerConfiguration*) getConfiguration();
  TString bn = getHistoBaseName();

  if (reportInfo("ParticlePairDerivedHistos",getName(),"loadHistograms(TFile * inputFile)")) cout << endl << "Completed." << endl;
}
...
double ParticlePairDerivedHistos::calculateWeightCorrection(TFile * fRaw,
                                                            TFile * fCal)
{
  if (reportStart("ParticlePairDerivedHistos",getName(),"calculateWeightCorrection(...)"))
    ;
  ...
  if (reportEnd("ParticlePairDerivedHistos",getName(),"calculateWeightCorrection(...)"))
    ;
...
void ParticlePairDerivedHistos::calculatePairDerivedHistograms(ParticleHistos     & part1Histos,
                                                               ParticleHistos     & part2Histos,
                                                               ParticlePairHistos & pairHistos,
                                                               double bincorrection)
{
  if (reportStart("ParticlePairDerivedHistos",getName(),"calculatePairDerivedHistograms(...)"))
    ;
  ParticlePairAnalyzerConfiguration & ac = * (ParticlePairAnalyzerConfiguration*) getConfiguration();
  ...
  if (ac.fillEta)
    ...
    if (ac.computeDptDpt || ac.computeP2  || ac.computeG2)
      ...
      h_P2_phiPhi->Scale(scalingFactorEta);
  ...
  if (ac.fillY)
    ...
    if (ac.computeP2)
      ...
      double scalingFactorY = 1.0/avgPt1Y/avgPt2Y;
  ...
  if (reportEnd("ParticlePairDerivedHistos",getName(),"calculatePairDerivedHistograms(...)"))
    ;
}
