...
int CalculateXsectSlices()
{
  ...
  TString inputPathName = "/Users/claudeapruneau/Documents/GitHub/WAC4/data//OutputFiles//PYTHIA/7TEV/V0AccTestHadronsOnlyWithColorReconnNoWeakDecay/";
  TString inputFileName = "PYTHIA_pp_7TeV_inelastic_G1_Sum.root";
  TString histoName = "G1_PF0nGeq1Lt1000_HC_n";
