...
int RunPythiaAnalysisV2()
{
  ...
  unsigned long nEventRequested   =  9999999; //1999999;
  unsigned long nEventReported    =  1000000;
  unsigned long nEventPartialSave =  1000000;
  bool    partialSave             = true; // false; //
  bool    subsampleAnalysis       = true; // false; //
  ...
  //outputPathName += "/PYTHIA/7TEV/V0AccClassesWithColorReconnNoWeakDecayShortTest/";  //  99
  //outputPathName += "/PYTHIA/7TEV/V0AccClassesWithColorReconnNoWeakDecayLongTest/";  //  9999999
  ...
  pythiaOptions.push_back( new TString("Next:numberShowInfo = 0") );            // print event information n times
...
*/
  ...
  p1ConfigND->fillEta     = true;
  p1ConfigND->fillP2      = true;
  ...
  p2ConfigND->fillEta     = true;
  p2ConfigND->fillP2      = false;
  p2ConfigND->nBins_n1    = 100;
  p2ConfigND->min_n1      = 0.0;
  p2ConfigND->max_n1      = 100.0;
  p2ConfigND->nBins_n2    = 100;
  p2ConfigND->min_n2      = 0.0;
  p2ConfigND->max_n2      = 400.0;
...
//  limits.push_back(400.0); // 0-10%
  ...
  int analysisOptionP1 = 5;
  int analysisOptionP2 = 5;
...
//  comb.push_back(2);comb.push_back(5); p2ConfigND->combinations.push_back( comb );
  ...
  ParticleAnalyzerV2 * particleAnalyzer          = new ParticleAnalyzerV2("P1",   p1ConfigND, eventFiltersP1Ana, particleFiltersP1Ana, messageLevel);
  ParticlePairAnalyzerV2 * particlePairAnalyzer  = new ParticlePairAnalyzerV2("P2", p2ConfigND, eventFiltersP2Ana, particleFiltersP2Ana, messageLevel);
